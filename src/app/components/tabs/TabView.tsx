...
import { Message, ChatExample, TabStatus, TabState, ChatContext } from "@/app/types/chat";
...
export default function TabView() {
  ...
  const [tabStates, setTabStates] = React.useState<TabState[]>(
    examples.map((_, idx) => ({
      status: idx === 0 ? "active" : "inactive",
      messages: []
    }))
  );
  const [sidebarSections, setSidebarSections] = React.useState<SidebarSection[]>([
  ...
  return (
    <div className="h-screen flex">
      <div className="flex-1 flex flex-col">
        <div className="flex border-b border-white/[0.05] bg-black/40 backdrop-blur-sm">
        ...
        <div className="flex-1 flex justify-center items-center p-8 bg-gradient-to-b from-black to-gray-900">
      ...
      <div className="w-[300px] border-l border-white/[0.05] bg-black/40 backdrop-blur-sm flex flex-col">
