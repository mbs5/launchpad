...
exports.activityLogAttributes = exports.Activity = void 0;
...
class Activity {
    constructor(info, fn, dataConverter, heartbeatCallback, workerLogger, interceptors) {
        ...
        this.workerLogger = (0, logger_1.withMetadata)(workerLogger, () => this.getLogAttributes());
        ...
        (0, logger_1.withMetadata)(this.workerLogger, { sdkComponent: common_1.SdkComponent.activity }));
