 ...
 */
export interface CompiledWorkerOptions extends Omit<WorkerOptionsWithDefaults, 'serverOptions' | 'interceptors' | 'activities' | 'tuner'> {
...
export declare function compileWorkerOptions(rawOpts: WorkerOptions, logger: Logger): CompiledWorkerOptions;
