...
exports.compileWorkerOptions = exports.appendDefaultInterceptors = exports.defaultSinks = exports.isPathBundleOption = exports.isCodeBundleOption = void 0;
...
function addDefaultWorkerOptions(options, logger) {
    const { buildId, useVersioning, maxCachedWorkflows, showStackTraceSources, namespace, sinks, nonStickyToStickyPollRatio, interceptors, maxConcurrentActivityTaskExecutions, maxConcurrentLocalActivityExecutions, maxConcurrentWorkflowTaskExecutions, ...rest } = options;
...
function compileWorkerOptions(rawOpts, logger) {
    ...
    const tuner = (0, worker_tuner_1.asNativeTuner)(opts.tuner);
    return {
        ...opts,
