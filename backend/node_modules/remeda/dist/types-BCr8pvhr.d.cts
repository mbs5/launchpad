import { EmptyObject, IsAny, Simplify, Writable, IsLiteral, IsNever, KeysOfUnion, IsStringLiteral, IsNumericLiteral, IsSymbolLiteral, Split, IsEqual, IfNever, Tagged } from 'type-fest';
...
type UpsertProp<T, K extends PropertyKey, V> = Simplify<Omit<T, K> & (IsSingleLiteral<K> extends true ? Writable<Required<Record<K, V>>> : // The key is either a broad type (`string`) or union of literals
{
